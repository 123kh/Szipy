                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                                <div class="form-group">
                                    ...
                                    <form role="form" method="POST" action="{{route('update-internal')}}" >
                                        {{csrf_field()}}
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group" style="margin-top:-10px;">   
                                            ...
                                            <div class="col-md-2" style="margin-top:15px;">
                                                ...
                                                <input type="text" placeholder=" Title" class="form-control" name="title" value="{{$internal->Title}}" required input/>
                                            </div>

                                         
                                            <div class="col-md-2" style="margin-top:15px;">
                                                <label>Date<font color="#FF0000">*</font></label>
                                                <input type="date" placeholder=" Date" class="form-control" name="date"  value="{{$internal->Date}}" required input/>
                                            </div>

                                            <div class="col-md-3" style="margin-top:15px;">
                                                <label>Description<font color="#FF0000">*</font></label>
                                                 <textarea  class="form-control" name="description"  cols="4" rows="2"  value="{{$internal->Description}}">{{$internal->Description}}</textarea>
                                                 </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body" style="margin-top:-10px; margin-bottom:-15px;">
                                        <table class="table datatable"> 
                                            ...
                                            <tbody>
                                            @foreach($internalnotifications as $internal)
                                                 <tr>
                                                    <td>{{$loop->index+1}}</td>
                                                    ...
                                                    <a href="{{route('edit-internal',$internal->id)}}"><button style="background-color:#0066cc; border:none; max-height:25px; margin-top:-5px; margin-bottom:-5px;" type="button" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit Item"><i class="fa fa-edit" style="margin-left:5px;"></i></button></a>  
