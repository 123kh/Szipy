                ...
                <div class="page-content-wrap">
                  ...
                  <div class="row">
                     ...
                     @endif
                                    	...
                                    	<form method="POST" enctype="multipart/form-data" action="{{route('restro_vendor')}}">
                                        {{ csrf_field()}}
                                        <div class="col-md-12">
                                            ...
                                            <table class="table datatable">
                                                ...
                                                @foreach($restro as $restro)
                                                     <tr>
                                                        ...
                                                        <a href="{{route('edit-restro',$restro->id)}}">
                                                            <button style="background-color:#0066cc; border:none; max-height:25px; margin-top:-5px; margin-bottom:-5px;" type="button" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit Item"><i class="fa fa-edit" style="margin-left:5px;"></i></button> </a>      
