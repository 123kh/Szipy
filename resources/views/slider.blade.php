                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                                    <div class="form-group">
                                    	...
                                    	<form role="form"  method="POST" enctype="multipart/form-data" action="{{route('create_slider')}}">
                                        {{ csrf_field()}}
                                        <div class="col-md-12">
                                        ...
                                        @foreach ($maincategory as $maincategorys)
                                           ...
                                           @endforeach
                                                ...
                                                <div class="col-md-2" style="margin-top:15px;">
                                                <label>Upload Image<font color="#FF0000">*</font></label>
                                                <input type="file" placeholder="Upload Image" class="form-control" name="image" required input/>
                                            </div>
                                            ...
                                            <table class="table datatable">
                                                ...
                                                @foreach($slider as $slider)
                                                     <tr>
                                                        ...
                                                        <td>{{$slider->main}}</td>
                                                        <td>
                                                            <a href="{{asset('restro_img/')}}/{{$slider->upload_image}}">{{$slider->upload_image}}</a>
                                                            
                                                        </td>
                                                      
                                                        <td>
                                                         
                                                            <a href="{{route('destroy-slider',$slider->id)}}"> <button style="background-color:#ff0000; border:none; max-height:25px; margin-top:-5px; margin-bottom:-5px;" type="button" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Delete Item"><i class="fa fa-trash-o" style="margin-left:5px;"></i></button></a>                                           
                                                        </td>
                                                    </tr>
