...
<div class="page-content-wrap">
              ...
              <div class="row">
                    <div class="col-md-12" >
                     ...
                     @endif
                                    <form role="form" method="POST" enctype="multipart/form-data" action="{{route('internal_notification')}}" >
                                        {{csrf_field()}}
                                    <div class="col-md-12">
                                        <div class="form-group" style="margin-top:-10px;">   
                                            ...
                                            <div class="col-md-2" style="margin-top:15px;">
                                                ...
                                                <input type="date" placeholder="Date " class="form-control" name="date" required input/>
                                            </div>
