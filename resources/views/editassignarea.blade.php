                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                                <div class="form-group">
                                    ...
                                    <form role="form" method="POST" action="{{route('update-assignarea')}}" >
                                        {{csrf_field()}}
                                        
                                        <input type="hidden"  name="id"  value="{{$assignarea_edit->id}}">
                                    <div class="col-md-12">
                                        <div class="form-group" style="margin-top:-10px;">   
                                            ...
                                            <div class="col-md-2" style="margin-top:15px;">
                                                ...
                                                <select class="form-control select" data-live-search="true" name="select_vendor_id">
                                                    ...
                                                    @foreach ($restrovendor as $restrovendors)
                                                  <option value="{{$restrovendors->id}}" @if($assignarea_edit->Select_Vendor_id==$restrovendors->id) selected @endif >{{$restrovendors->Restro_Name}}</option>
                                           @endforeach
                                        </select>                                            
                                            </div>
                                            ...
                                            <div class="col-md-2" style="margin-top:15px;">
                                                ...
                                                <select class="form-control select" data-live-search="true" name="city_id">
                                                  ...
                                                  <option value="{{$citys->id}}" @if($assignarea_edit->City_id==$citys->id) selected @endif >{{$citys->city}}</option>
                                           @endforeach
                                        </select>
                                            </div>
                                            ...
                                            <div class="col-md-3" style="margin-top:15px;">
                                                ...
                                                <select class="form-control select" data-live-search="true" name="area_id">
                                                  ...
                                                  <option value="{{$areas->id}}" @if($assignarea_edit->Area_id==$areas->id) selected @endif >{{$areas->Area}}</option>
                                           @endforeach
                                        </select>                                                 </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body" style="margin-top:-10px; margin-bottom:-15px;">
                                        <table class="table datatable"> 
                                            ...
                                            <tbody>
                                            @foreach($assignarea as $assignareas)
                                                 <tr>
                                                    <td>{{$loop->index+1}}</td>
