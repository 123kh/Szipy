            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                    <div class="form-group">
                        ...
                        <form role="form" method="POST" action="{{route('update-main')}}">
                            {{csrf_field()}}
                            
                           
                            <input type="hidden"  name="id"  value="{{$main_edit->id}}">
                             ...
                             <div class="col-md-3"></div>
                                <div class="col-md-4" style="margin-top: 15px;">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" placeholder="Main-Category"  name="main" class="form-control" value="{{$main_edit->main}}" required input/>
                            ...
                            <table class="table datatable">
                                ...
                                @foreach($main as $main)
                                     <tr>
                                        ...
                                        <td>
                                        <a href="{{route('edit_main',$main->id)}}">
