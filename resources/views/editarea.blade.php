                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                                <div class="form-group">
                                    ...
                                    <form role="form"  method="POST" action="{{route('update-area')}}">
                                    {{csrf_field()}}
                                        ...
                                        <div class="form-group" style="margin-top:-10px;">   
                                            ...
                                            <div class="col-sm-2" style="margin-top: 15px;">
                                                <div class="form-group ">
                                                  ...
                                                  <option value="{{$area->id}}" @if($edit_area->Select_City_id==$area->id) selected @endif >{{$area->city}}</option>
                                           @endforeach
                                        </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2" style="margin-top:15px;">
                                                ...
                                                <input type="text" placeholder="Area" class="form-control" name="area" value="{{$edit_area->Area}}" required input/>
</div>
                                        ...
                                        <table class="table datatable">
                                            ...
                                            @foreach($areac as $area)
                                                 <tr>
                                                    ...
                                                    <a href="{{route('edit-area',$area->id)}}">  <button style="background-color:#0066cc; border:none; max-height:25px; margin-top:-5px; margin-bottom:-5px;" type="button" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit Item"><i class="fa fa-edit" style="margin-left:5px;"></i></button>  </a>            
