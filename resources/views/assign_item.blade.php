                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12" style="margin-bottom:-5px;" align="center">
                                <h6 style="color:#000; background-color:#FFCC00; width:15%; min-height:25px; padding-top:5px;"
                                    align="center"><span class=""></span> <strong> Assign Item To</strong></h6>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <h5 class="panel-title" style="color:#FFFFFF; background-color:#0a0536; width:100%; font-size:14px;"
                    align="center"><i class="fa fa-users"></i> Assign Item To</h5>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group" style="margin-top:-10px;">
                                    ...
                                    <div class="col-sm-2" style="margin-top:15px;">
                                        ...
                                        <select id="Main_Category_id" class="form-control select" data-live-search="true"
                                            name="main_category">
                                    ...
                                    <div class="col-sm-2" style="margin-top:15px;">
                                        <label>Select Item<font color="#FF0000">*</font></label>
                                        <select id="item_name_id" class="form-control select" data-live-search="true"
                                            name="item_name_id">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group" style="margin-top:26px; margin-bottom:30px;">
                                    ...
                                    @foreach ($assign as $assign)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('edit-assign', $assign->id) }}"><button
                                                        style="background-color:#0066cc; border:none; max-height:25px; margin-top:-5px; margin-bottom:-5px;"
                                                        type="button" class="btn btn-info" data-toggle="tooltip"
                                                        data-placement="top" title="Edit Item"><i class="fa fa-edit"
                                                            style="margin-left:5px;"></i></button> </a>
                                                <a href="{{ route('destroy-assign', $assign->id) }}"><button
                                                        style="background-color:#ff0000; border:none; max-height:25px; margin-top:-5px; margin-bottom:-5px;"
                                                        type="button" class="btn btn-info" data-toggle="tooltip"
                                                        data-placement="top" title="Delete Item"><i class="fa fa-trash-o"
                                                            style="margin-left:5px;"></i></button> </a>
                                            </td>
                                        </tr>
                                    @endforeach
            ...
            $(document).on("change", "#Main_Category_id", function() {
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        $("#item_name_id").empty();
                        $("#item_name_id").append('<option>Select Item</option>');
                        $.each(result, function(a, b) {
                            $("#item_name_id").append(
                                '<option value="' +
                                b.id + '">'+ b.Item_Name + '</option> />');
                        })
                        $("#item_name_id").selectpicker('refresh');
                    }
                });
            })
        })
