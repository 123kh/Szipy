  ...
  <div class="page-content-wrap">
              ...
              <div class="row">
                    <div class="col-md-12" >
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                                <div class="form-group">
                                    ...
                                    <form role="form" method="POST" enctype="multipart/form-data" action="{{route('update-delivery')}}" >
                                    {{csrf_field()}}
                     ...
                     @endif
                                    <input type="hidden"  name="id"  value="{{$delivery_edit->id}}">
                                    <input type="hidden"  name="old_password"  value="{{$delivery_edit->password}}">
                                    <div class="col-md-12">
                                        <div class="form-group" style="margin-top:-10px;">   
                                                         
                                            <div class="col-md-2" style="margin-top:15px;">
                                                <label> Name<font color="#FF0000">*</font></label>
                                                <input type="text" placeholder="Name" class="form-control" name="name" value="{{$delivery_edit->fullname}}" required input/>
                                            </div>

                                         
                                            <div class="col-md-2" style="margin-top:15px;">
                                                <label>Contact No<font color="#FF0000">*</font></label>
                                                <input type="number" placeholder=" Contact No" class="form-control" name="contact_no" value="{{$delivery_edit->mobile_number}}" required input/>
                                            </div>

                                             
                                            <div class="col-md-2" style="margin-top:15px;">
                                                <label>Email Id<font color="#FF0000">*</font></label>
                                                <input type="email" placeholder="Email Id" class="form-control" name="email_id" value="{{$delivery_edit->email}}" required input/>
                                            </div>

                                            <div class="col-md-2" style="margin-top:15px;">
                                                <label>Account No.<font color="#FF0000">*</font></label>
                                                <input type="number" placeholder="Account No" class="form-control" name="account_no" value="{{$delivery_edit->delivery_details->Account_No ?? ''}}" required input/>
                                            </div>
                                            <div class="col-md-2" style="margin-top:15px;">
                                                <label>User Name<font color="#FF0000">*</font></label>
                                                <input type="text" placeholder="User Name" class="form-control" name="username" value="{{$delivery_edit->username}}" required input/>
                                            </div>

                                            <div class="col-md-2" style="margin-top:15px;">
                                                <label>Password<font color="#FF0000">*</font></label>
                                                <input type="Password" placeholder="Password" class="form-control" name="password">
                                                <input type="hidden" name="old_password" value="{{$delivery_edit->Password}}" required input/>

                                            </div>
                                            <div class="col-md-2" style="margin-top: 15px;">
                                                <div class="form-group ">
                                                    <label>Branch<font color="#FF0000">*</font></label>
                                                    <input type="text" placeholder="Branch" class="form-control" name="branch" value="{{$delivery_edit->delivery_details->Branch ?? ''}}" required input/>
